...
function [] = report_figs(fig)
   ...
   switch fig
      ...
      case {1,"1"}
         ...
         print('figures/rel_err.tikz','-dtikz',SIZE);
      ...
      case {2,"2"}
         ...
         print('figures/orb_h.tikz','-dtikz',SIZE);
      ...
      case {3,"3"}
         ...
         print('figures/lyap_full.tikz','-dtikz',SIZE);
      ...
      case {4,"4"}
         ...
         ylabel('$\mu_{max}$ ($\mathrm{yr}^{-1}$)','Interpreter','tex');
         legend('data','fit');
         print('figures/lyap_zoom_fit.tikz','-dtikz',SIZE);
